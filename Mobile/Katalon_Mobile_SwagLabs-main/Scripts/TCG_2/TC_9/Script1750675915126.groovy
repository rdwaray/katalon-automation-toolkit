...
Mobile.verifyElementText(findTestObject('Object Repository/android.widget.TextView - 2'), '2')

Mobile.tap(findTestObject('Object Repository/android.widget.TextView - REMOVE'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.TextView - REMOVE (1)'), 0)
