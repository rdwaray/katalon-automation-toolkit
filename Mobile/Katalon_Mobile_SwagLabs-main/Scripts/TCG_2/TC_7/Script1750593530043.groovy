...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Sauce Labs Backpack'), 0)

Mobile.verifyElementVisible(findTestObject('Object Repository/android.widget.TextView - Sauce Labs Backpack'), 0)
