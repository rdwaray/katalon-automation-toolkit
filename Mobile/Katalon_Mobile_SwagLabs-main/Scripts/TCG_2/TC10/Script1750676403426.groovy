...
Mobile.verifyElementText(findTestObject('Object Repository/android.widget.TextView - Sauce Labs Backpack (2)'), 'Sauce Labs Backpack')

Mobile.verifyElementText(findTestObject('Object Repository/android.widget.TextView - Sauce Labs Bike Light (2)'), 'Sauce Labs Bike Light')
