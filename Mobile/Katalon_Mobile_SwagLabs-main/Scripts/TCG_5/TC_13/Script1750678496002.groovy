...
Mobile.delay(1)
Mobile.tapAtPosition(1120, 390)

Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Price (high to low)'), 0)

Mobile.delay(1)
Mobile.tapAtPosition(1120, 390)

Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Name (Z to A)'), 0)
