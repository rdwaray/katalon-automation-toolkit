...
Mobile.sendKeys(findTestObject('Object Repository/android.widget.EditText - Username'), 'locked_out_user')
...
Mobile.verifyElementText(findTestObject('Object Repository/android.widget.TextView - Sorry, this user has been locked out'), 
