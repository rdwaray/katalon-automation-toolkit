...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - DRAWING'), 0)

Mobile.swipe(900, 900, 900, 1500)  
...
Mobile.getText(findTestObject('Object Repository/android.widget.TextView - Drawing saved successfully to gallery'), 0)
