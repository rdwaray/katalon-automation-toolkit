...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - GEO LOCATION'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - While using the app'), 0)

Mobile.takeScreenshot('C:\\Users\\Ray\\AppData\\Local\\Temp\\screenshot18098748079398352861.png')
